	...
	<div id="wrapper">
		...
		<div id="container">
			<div class="row">
				<div class="col-lg-12">
					<%
					String tmp = request.getParameter("b");
					String p = request.getParameter("p");
					if(tmp.equals("freeboard")) {
				%>
					<h1>글쓰기 - 자유게시판</h1>
					<script type="text/javascript">
 				...
 				%>
					...
					<form method="post" action=".././dao/bWriteProcess.jsp"
						id="bWriteProcess">
						...
						<input type="hidden" name="at_type" value="<%=tmp%>"> <input
